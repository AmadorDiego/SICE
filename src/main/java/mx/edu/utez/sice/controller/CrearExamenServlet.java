...
<<<<<<< HEAD
        examen.setEstado(Integer.parseInt(req.getParameter("estado")));
=======
        examen.setEstado(true); // Asumimos que el examen se crea activo
>>>>>>> 152ed2d6e57f4fa9bb9a3832ee275f874d73af08
