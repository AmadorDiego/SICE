...
@WebServlet (name = "CrearGrupoServlet", value = "/CrearGrupoServlet")
public class CrearGrupoServlet extends HttpServlet {
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (grupoDao.crearGrupo(id_carrera, grado, grupo, id_periodo)){
            sesion.setAttribute("mensajeAdministrador","Se creo correctamente el grupo");
            sesion.setAttribute("flag", true);
        }else {
            sesion.setAttribute("mensajeAdministrador","Ocurrio un error al crear el grupo");
