...
<div class="container-xl">
    <div class="row">
        <div class="col-12">
            <hr>
            <h3 class="text-center"><strong>Alumnos y docentes</strong></h3>
            <hr>
        </div>
        <!---//////////////////////////////////////Contenido//////////////////////////////////////////////////-->
        <div class="row">
            <div class="col-12">
                <div class="table-responsive rounded-4  d-flex d-md-block">
                    <table id="usuarios" class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td class="d-none d-md-table-cell"><%=u.getEstado() == 1 ? "Habilitado" : "Deshabilitado"%>
                            </td>
                            ...
                            <td>
                                ...
                                <%} else { %>
                                <button type="button" class="btn btn-success bg-green-SICE border-0 text-white"
                                        data-bs-toggle="modal" data-bs-target="#exampleModal_<%= u.getId_usuario() %>">
