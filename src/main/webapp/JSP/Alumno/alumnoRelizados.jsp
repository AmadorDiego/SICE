        ...
        <div class="col-12 col-md-6 p-4">
            <div class="card rounded-5 border-0 bg-green-utz">
                ...
                <div class="card-body shadow-lg bg-light rounded-bottom border-0">
                    <h3 class="card-title green-utz"><strong><%=examen.getNombre_examen()%>
                    </strong></h3>
                    <h6 class="card-text "><%=examen.getDescripcion()%>
                    </h6>
                    <div class="p-4 d-flex flex-row-reverse bd-highlight gap-2">
                        <a href="../../ExamenCompletadoServlet?id_examen=<%=examen.getId_examen()%>"
                           class="btn btn-success bg-green-utz text-white">Ver respuestas</a>
